import{c as o,d as i,y as t,_ as e,v as n,g as a}from"./index-4d2c92b7.js";const r=o`
  :host {
...
`;class s extends i{static{this.styles=[r]}render(){return t`
      <slot name="icon">
        ${this.icon?t`<oryx-icon .type=${this.icon}></oryx-icon>`:t``}
      </slot>
      <slot class="text"></slot>
    `}}e([n(),a("design:type",String)],s.prototype,"icon",void 0);export{s as NavigationItemComponent};
