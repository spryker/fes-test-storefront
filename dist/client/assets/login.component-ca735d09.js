import{c,r as h,B as l,j as d,H as p,t as i,l as u,I as y,y as s,f as g,J as x,K as $,_ as m,g as b,h as f,R as w,M as v,N as S,E as C,o}from"./index-74abacf3.js";import{s as R}from"./subscribe.decorator-f722d0fb.js";import{C as L}from"./content.controller-bfcf20c7.js";import{C as j}from"./component.mixin-ae2cf780.js";const k=c`
  oryx-card form > * {
    margin: 10px 0;
  }
...
`;var a;let n=(a=class extends j(){constructor(){super(...arguments),this.contentController=new L(this),this.routerService=h(w),this.authService=h(v),this.options$=this.contentController.getOptions(),this.success$=new l(!0),this.loading$=new l(!1),this.data$=d([this.options$,this.loading$,this.success$]),this.authTrigger$=new p(1),this.auth$=this.authTrigger$.pipe(i(()=>this.loading$.next(!0)),u(e=>this.authService.login({username:e.email,password:e.password,remember:e.rememberme}).pipe(S(r=>(this.success$.next(!1),this.loading$.next(!1),C)))),y(this.options$),u(([e,r])=>e?r.disableRedirect?o(void 0):r.url?(this.routerService.navigate(r.url),o(void 0)):this.routerService.previousRoute().pipe(i(t=>{if(t){this.routerService.navigate(t);return}this.routerService.navigate("/")})):(this.success$.next(e),o(void 0))),i({next:()=>this.success$.next(!0),complete:()=>this.loading$.next(!1)}))}handleLogin(e){e.preventDefault();const r=e.target,t=new FormData(r);this.authTrigger$.next({email:t.get("email"),password:t.get("password"),rememberme:!!t.get("rememberme")})}render(){return s`${g(this.data$,([e,r,t])=>s`<oryx-card>
    ...
    </oryx-card>`)}`}},(()=>{a.styles=k})(),a);m([R(),b("design:type",Object)],n.prototype,"auth$",void 0);n=m([f()],n);export{n as AuthLoginComponent};
