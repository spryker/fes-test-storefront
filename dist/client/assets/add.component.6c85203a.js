import{Y as C,Z as g,$ as v,a0 as S,a1 as f,a2 as B,a3 as w,c as I,r as q,j as y,a4 as m,m as h,B as $,a5 as E,t as p,I as M,l as k,N as z,y as r,f as s,a6 as Q,_ as c,g as _,h as P,a7 as j,o as A}from"./index.4dee5cd5.js";import{s as O}from"./subscribe.decorator.9a239dd0.js";import{C as R}from"./content.controller.2f1fd9c8.js";import{P as T}from"./product.controller.30fcb264.js";import{P as L}from"./product.mixin.0505c424.js";import{B as U}from"./button.component.5d16c298.js";import{S as d}from"./common.49548711.js";import{i as F}from"./i18n.directive.96297578.js";import{e as N,n as V}from"./ref.afd3aedc.js";import{t as W,a as Y}from"./timer.9ebdb69e.js";import"./context.controller.c080d1c5.js";import"./component.mixin.d2c5a023.js";function Z(){return C(function(n,t){n.subscribe(g(t,v))})}function x(n,t){return t?function(i){return S(t.pipe(f(1),Z()),i.pipe(x(n)))}:B(function(i,e){return n(i,e).pipe(f(1),w(i))})}function D(n,t){t===void 0&&(t=Y);var i=W(n,t);return x(function(){return i})}const G=I`
  :host {
    display: flex;
    flex-wrap: wrap;
    gap: 12px 17px;
