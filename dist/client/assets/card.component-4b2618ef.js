import{c as s,d as n,y as l,_ as r,v as t,g as a}from"./index-4d2c92b7.js";var e;(function(o){o.PRIMARY="primary",o.SECONDARY="secondary"})(e||(e={}));const p=s`
  :host {
...
`;class d extends n{static{this.styles=p}render(){return l`
      <slot name="header">
        <h5>${this.header}</h5>
      </slot>
      <slot part="body"></slot>
      <slot name="footer"></slot>
    `}}r([t({reflect:!0}),a("design:type",String)],d.prototype,"type",void 0);r([t(),a("design:type",String)],d.prototype,"header",void 0);export{d as CardComponent};
