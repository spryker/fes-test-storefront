import{c as l,z as r,d as v,y as s,K as u,_ as o,v as t,g as i}from"./index-41c5945f.js";import{P as a}from"./common-0ee98dc0.js";var d;(function(b){b.PRIMARY="primary",b.SECONDARY="secondary"})(d||(d={}));const y=l`
  dialog {
    all: unset;
    position: fixed;
    inset: auto;
...
`,m=l`
  ...
  :host([type='${r(d.SECONDARY)}']) dialog::before {
...
`,p=class extends v{constructor(){super(...arguments),this.notClosable=!1,this.open=!1,this.notResizable=!1,this.navAriaLabel="drawer navigation",this.closeButtonAriaLabel="close the drawer",this.minimizeButtonAriaLabel="minimize the drawer",this.maximizeButtonAriaLabel="maximize the drawer"}get dialog(){var n;return(n=this.shadowRoot)==null?void 0:n.querySelector("dialog")}renderTemplate(){return s`
      <nav aria-label=${this.navAriaLabel}>
        ${u(!this.notClosable,()=>s`
            <button value="cancel" aria-label=${this.closeButtonAriaLabel}>
              <oryx-icon type="close"></oryx-icon>
            </button>
          `)}
        ${u(!this.notResizable,()=>s`
            <button
