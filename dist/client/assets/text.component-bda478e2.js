import{V as g,aF as y,at as c,c as b,d as x,K as f,_ as a,v as r,g as l}from"./index-74abacf3.js";import{t as v}from"./throttle-4a4cf116.js";import{e as w,n as k}from"./ref-ede9cacd.js";class z extends y{render(t,n){return c``}}const _=g(z),$=async e=>{var o;const t=(o=e.shadowRoot)==null?void 0:o.querySelector("div > *"),n=Number(getComputedStyle(e).getPropertyValue("--line-clamp"));if(t&&n>0){const s=t.style.lineHeight,p=1e3;t.style.lineHeight=`${p}px`;const h=t.getBoundingClientRect().height;t.style.lineHeight=s;const u=Math.floor(h/p);if(e.style.setProperty("--lines-count",String(u)),u<=n)return;const m=e.hasAttribute("defaultExpanded");e.toggleAttribute("truncated",!m),e.toggleAttribute("truncation",!0)}},B=b`
  :host {
...
`,d=class extends x{constructor(){super(...arguments),this.hideToggle=!1,this.truncated=!1,this.truncation=!1,this.readMoreLabel="Read more",this.containerRef=w()}disconnectedCallback(){var t;(t=this.resizeObserver)==null||t.disconnect(),super.disconnectedCallback()}get container(){var t;return(t=this.containerRef)==null?void 0:t.value}get shouldBeTruncated(){return!!Number(getComputedStyle(this).getPropertyValue("--line-clamp"))}render(){return c`
      <div ${k(this.containerRef)}>
        <slot @slotchange=${this.setup.bind(this)}></slot>
      </div>
      ${f(!this.hideToggle,()=>c` <slot name="toggle">
