...
`,e=class extends r{constructor(){super(...arguments),this.toggleButtonAriaLabel="collapse navigation",this.collapse=new c(this)}render(){return l`
    ...
    `}toggle(){this.collapse.toggle()}};let t=e;(()=>{e.styles=[g]})();i([a(),n("design:type",String)],t.prototype,"toggleButtonAriaLabel",void 0);export{t as NavigationComponent};
