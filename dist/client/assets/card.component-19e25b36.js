import{c as n,d as l,y as p,_ as a,v as d,g as s}from"./index-41c5945f.js";var t;(function(r){r.PRIMARY="primary",r.SECONDARY="secondary"})(t||(t={}));const y=n`
  :host {
...
`,e=class extends l{render(){return p`
      <slot name="header">
        <h5>${this.header}</h5>
      </slot>
      <slot part="body"></slot>
      <slot name="footer"></slot>
    `}};let o=e;(()=>{e.styles=y})();a([d({reflect:!0}),s("design:type",String)],o.prototype,"type",void 0);a([d(),s("design:type",String)],o.prototype,"header",void 0);export{o as CardComponent};
