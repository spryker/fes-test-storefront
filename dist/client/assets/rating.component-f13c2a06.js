import{c as s,d,y as t,K as n,_ as r,v as o,g as a}from"./index-4d2c92b7.js";const h=s`
  :host {
...
`,u=25;class i extends d{constructor(){super(...arguments),this.scale=5}static{this.styles=[h,p,c]}render(){return t`
      <fieldset style=${`--rate: ${this.getValue()};`}>
        ${[...Array(Math.min(this.scale,u))].map((e,l)=>this.renderInput(l))}
      </fieldset>

      ${n(this.reviewCount!==void 0,()=>t`<span class="review-count">${this.getCount()}</span>`)}
      ${this.renderClipPath()}
    `}renderInput(e){return t`<input
        ...
        style=${`--pos: ${e+1}`}
        aria-label=${e+1}
      />${n(!this.readonly,()=>this.renderSlot(e))}`}renderSlot(e){return t`<slot name=${e+1} ?has-char=${this.hasChar(e)}
      >${this.getChar(e)??t`<svg viewBox="0 0 18 18">
        <use href="#star" />
      </svg>`}</slot
    >`}renderClipPath(){return t`
    ...
    `}getValue(){return this.value??0}setValue(e){this.value=e}getCount(){return this.reviewCount}hasChar(e){return[...this.characters??[]].length>e}getChar(e){if(!!this.hasChar(e))return[...this.characters??[]][e]}}r([o({type:Number}),a("design:type",Number)],i.prototype,"value",void 0);r([o({type:Boolean,reflect:!0}),a("design:type",Boolean)],i.prototype,"readonly",void 0);r([o(),a("design:type",Object)],i.prototype,"reviewCount",void 0);r([o({type:Number}),a("design:type",Object)],i.prototype,"scale",void 0);r([o(),a("design:type",String)],i.prototype,"characters",void 0);r([o({reflect:!0}),a("design:type",String)],i.prototype,"size",void 0);export{i as RatingComponent};
