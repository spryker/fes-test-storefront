import{c as n,d as c,y as p,_ as a,v as s,g as r}from"./index-74abacf3.js";const h=n`
...
`,l=class extends c{constructor(){super(...arguments),this.backdropTargetTag="dialog",this.closeEvent="oryx.close"}requestUpdate(e,o){e==="isOpen"&&this.isOpen!==o&&this.setDialogState(),super.requestUpdate(e,o)}firstUpdated(e){super.firstUpdated(e),this.setDialogState()}setDialogState(){var e,o,i,d;this.isOpen?(o=(e=this.dialog)==null?void 0:e.showModal)==null||o.call(e):(d=(i=this.dialog)==null?void 0:i.close)==null||d.call(i)}emitCloseEvent(){this.dispatchEvent(new CustomEvent(this.closeEvent,{bubbles:!0,composed:!0}))}close(){this.emitCloseEvent(),this.removeAttribute("open")}open(){this.toggleAttribute("open")}backdropClickHandler(e){if(e.stopPropagation(),this.disableCloseOnBackdrop)return;e.composedPath()[0].tagName.toLowerCase()===this.backdropTargetTag&&this.close()}cancelEventHandler(e){e.preventDefault(),e.stopImmediatePropagation(),this.disableCloseOnEscape||this.close()}get dialog(){var e;return(e=this.shadowRoot)==null?void 0:e.querySelector("dialog")}render(){return p`
      <dialog
