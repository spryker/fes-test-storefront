import{c as i,d as h,y as r,K as l,_ as o,v as s,g as a}from"./index-41c5945f.js";const p=i`
  :host {
...
`,v=25,n=class extends h{constructor(){super(...arguments),this.scale=5}render(){return r`
      <fieldset style=${`--rate: ${this.getValue()};`}>
        ${[...Array(Math.min(this.scale,v))].map((e,d)=>this.renderInput(d))}
      </fieldset>

      ${l(this.reviewCount!==void 0,()=>r`<span class="review-count">${this.getCount()}</span>`)}
      ${this.renderClipPath()}
    `}renderInput(e){return r`<input
        ...
        style=${`--pos: ${e+1}`}
        aria-label=${e+1}
      />${l(!this.readonly,()=>this.renderSlot(e))}`}renderSlot(e){return r`<slot name=${e+1} ?has-char=${this.hasChar(e)}
      >${this.getChar(e)??r`<svg viewBox="0 0 18 18">
        <use href="#star" />
      </svg>`}</slot
    >`}renderClipPath(){return r`
    ...
    `}getValue(){return this.value??0}setValue(e){this.value=e}getCount(){return this.reviewCount}hasChar(e){return[...this.characters??[]].length>e}getChar(e){if(!!this.hasChar(e))return[...this.characters??[]][e]}};let t=n;(()=>{n.styles=[p,c,u]})();o([s({type:Number}),a("design:type",Number)],t.prototype,"value",void 0);o([s({type:Boolean,reflect:!0}),a("design:type",Boolean)],t.prototype,"readonly",void 0);o([s(),a("design:type",Object)],t.prototype,"reviewCount",void 0);o([s({type:Number}),a("design:type",Object)],t.prototype,"scale",void 0);o([s(),a("design:type",String)],t.prototype,"characters",void 0);o([s({reflect:!0}),a("design:type",String)],t.prototype,"size",void 0);export{t as RatingComponent};
