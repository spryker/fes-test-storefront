import{D as r,c as l,B as z,y as $,f as A,j as C,N as u,O as M,t as E,_ as L,h as j}from"./index.65290630.js";import{C as D}from"./content.controller.53d4125f.js";import{P as H}from"./product.controller.4d401941.js";import{P as _}from"./product.mixin.0ef1a236.js";import"./context.controller.86df9e5b.js";import"./component.mixin.d9d48422.js";const I=r("[main-layout='none']"),v=r("[main-layout='toggle']"),S=r("[nav-position='bottom']"),B=r("[nav-position='top']"),x=r("[nav-position='start']"),p=r("[nav-position='end']"),a=r(`:is(${x}, ${p})`),e=r("[nav-layout='grid']"),m=r("[nav-display='floating']"),O=r("[nav-display='none']"),g=r("[nav-align='center']"),y=r("[nav-align='end']"),h=l`var(--product-images-main-height, 300px)`,N=l`var(--product-images-thumb-width, var(--product-images-thumb-height, min(15vw, 80px)))`,k=l`var(--product-images-thumb-height, var(--product-images-thumb-width, min(15vw, 80px)))`,T=l`
  section {
    position: relative;
    height: ${h};
...
`,J=l`
  ...
  ${T}
  ${F}
`;let f=class extends _(){constructor(){super(...arguments),this.product$=new H(this).getProduct().pipe(t=>this.reset(t)),this.options$=new D(this).getOptions().pipe(t=>this.reset(t)),this.active$=new z(0)}render(){return $`
