import{c as t,d as i,y as a,_ as o,v as r,g as e}from"./index-4d2c92b7.js";import"./input.styles-6d634215.js";import{E as d}from"./input.component-77513b1c.js";import"./screen-c0aae3c9.js";import"./query.util-00243645.js";import"./getControl-ea6b3b29.js";const n=t`
  :host {
...
`;class M extends i{constructor(){super(...arguments),this.errorController=new d(this)}static{this.styles=n}render(){return a`
      <label>
        <slot></slot>
      </label>
      ${this.errorController.render()}
    `}}o([r({type:Boolean,reflect:!0}),e("design:type",Boolean)],M.prototype,"intermediate",void 0);o([r(),e("design:type",String)],M.prototype,"errorMessage",void 0);o([r({type:Boolean}),e("design:type",Boolean)],M.prototype,"hasError",void 0);export{M as CheckboxComponent};
