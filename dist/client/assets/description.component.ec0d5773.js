import{au as e,f as i,u as a,_ as p,h as m}from"./index.0de56bf6.js";import{C as l}from"./content.controller.76e32ae1.js";import{P as c}from"./product.controller.e31c6526.js";import{P as d}from"./product.mixin.e8275ace.js";import"./context.controller.a49bc7fe.js";import"./component.mixin.5ee5865e.js";function u(o){return o.split(/(\r?\n\s*){2}/).map(t=>t.trim()).filter(t=>t.length).map(t=>`<p>${t}</p>`).join("").split(/(\r?\n\s*){1}/).map(t=>t.startsWith(`
