import{y as a,K as m,J as v,_ as f,v as q,g as $}from"./index.41f56078.js";import{C as g}from"./component.mixin.534dfd2f.js";import{e as b,n as I}from"./ref.3fdf67b2.js";import{a as x}from"./entry.model.f038ce94.js";import{contentBaseStyles as B}from"./content.styles.6c3e7e90.js";import"./screen.63347f27.js";class h extends g(){constructor(){super(...arguments),this.quantityInputRef=b()}updated(){var t,i,n,o,e;!((t=this.options)!=null&&t.updating)&&!((i=this.options)!=null&&i.confirmationRequired)&&this.quantityInputRef.value&&((n=this.quantityInputRef.value)==null?void 0:n.value)!==((o=this.options)==null?void 0:o.quantity)&&(this.quantityInputRef.value.value=(e=this.options)==null?void 0:e.quantity)}getDecreaseIcon(){var t,i;return((t=this.options)==null?void 0:t.removeByQuantity)===x.ShowBin&&((i=this.options)==null?void 0:i.quantity)===1?"trash":void 0}render(){var t,i,n,o,e,r,p;return a`
