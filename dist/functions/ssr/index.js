...
const y = ({ includeJSBuiltIns: n = !1, props: s = {} }) => {
  const o = /* @__PURE__ */ new WeakMap(), i = (t) => {
    let e = o.get(t);
  ...
  return l.window = l, n && Object.assign(l, {
    setTimeout() {
    },
    clearTimeout() {
    },
...
_();
const A = (n) => {
  const { entry: s, root: o = import.meta.url, namespace: i = "storefront" } = n, c = w(g(o)), a = y({
    includeJSBuiltIns: !0,
    props: {
      require: R(o),
      Event,
  ...
  try {
    const { root: o = "file:///var/task/dist/apps/storefront/functions/ssr/index.js", index: i = "../../client/index.html", component: c = "<root-app></root-app>", entry: a = "../../server/render.js" } = s, u = new URL(n.rawUrl), d = w(g(o)), m = f(b(d, i), "utf8"), l = await A({
      root: o,
      entry: a
    })({ route: u }), t = m.replace(c, l);
    return {
      statusCode: 200,
      headers: {
